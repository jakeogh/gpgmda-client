...
[thread]
    ...
    header = 'default','default','%(base0)s','%(base03)s','%(base0)s','%(base02)s'
    header_key = 'default','default','%(red)s','%(base03)s','%(red)s','%(base02)s'
    header_value = 'default','default','%(blue)s','%(base03)s','%(blue)s','%(base02)s'
    [[summary]]
